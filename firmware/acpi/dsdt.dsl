 ...
 *
 * Disassembly of dsdt.dat, Thu Mar 25 15:15:08 2021
 *
...
DefinitionBlock ("", "DSDT", 2, "MSFT  ", "MSFT    ", 0x00000002)
{
    ...
    Name (SS3, Zero)
    Name (SS4, One)
    OperationRegion (MNVS, SystemMemory, 0x7BF91000, 0x0040)
    ...
    OperationRegion (GNVS, SystemMemory, 0x7BFA4000, 0x07FA)
    ...
    OperationRegion (SNVS, SystemMemory, 0x7BFA3000, 0x001C)
    ...
    Scope (_SB.PCI0)
    {
        ...
        PowerResource (CAMP, 0x00, 0x0000)
        {
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                ADBG ("CAMP: _STA: PR Not Supported")
            }

            Method (_ON, 0, NotSerialized)  // _ON_: Power On
            {
                ADBG ("CAMP: _ON: PR Not Supported")
            }

            Method (_OFF, 0, NotSerialized)  // _OFF: Power Off
            {
                ADBG ("CAMP: _OFF: PR Not Supported")
            }
        }
    }
    ...
    Scope (_SB.PCI0.I2C2)
    {
        Device (CAMF)
        {
            ...
            Method (SSDB, 0, NotSerialized)
            {
                Name (PAR, Buffer (0x6C)
                {
                    ...
                    /* 0050 */  0x0A, 0x01, 0x02, 0x01, 0x01, 0x01, 0x00, 0xF8,  // ........
        ...
        Device (ICL1)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBUF) /* \_SB_.PCI0.I2C2.ICL1._CRS.SBUF */
            }
            ...
            Method (CLDB, 0, NotSerialized)
            {
                ...
                {
                    /* 0000 */  0x00, 0x01, 0x01, 0x20, 0x00, 0x0A, 0x01, 0x00,  // ... ....
                    /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00,  // ........
                    /* 0010 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00   // ........
                })
                Return (PAR) /* \_SB_.PCI0.I2C2.ICL1.CLDB.PAR_ */
            }
            ...
            Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("79234640-9e10-4fea-a5c1-b5aa8b19756f")))
                {
                    ...
                    Else
                    {
                        ADBG ("ICL1: Revision 1 not supported")
                    }
                }
    ...
    Scope (_SB.PCI0.I2C3)
    {
        Device (CAMR)
        {
            ...
            Method (SSDB, 0, NotSerialized)
            {
                Name (PAR, Buffer (0x6C)
                {
                    ...
                    /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0010 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x03, 0x04, 0x00, 0x00,  // ........
                    /* 0020 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0028 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0030 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0038 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
        ...
        Device (ICL0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBUF) /* \_SB_.PCI0.I2C3.ICL0._CRS.SBUF */
            }
            ...
            Method (CLDB, 0, NotSerialized)
            {
                Name (PAR, Buffer (0x20)
                {
                    /* 0000 */  0x00, 0x01, 0x00, 0x20, 0x00, 0x0A, 0x01, 0x00,  // ... ....
                    /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00,  // ........
                    /* 0010 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00   // ........
                })
                Return (PAR) /* \_SB_.PCI0.I2C3.ICL0.CLDB.PAR_ */
            }
            ...
            Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("79234640-9e10-4fea-a5c1-b5aa8b19756f")))
                {
                    ...
                    Else
                    {
                        ADBG ("ICL0: Revision 1 not supported")
                    }
                }
    ...
    Scope (_SB.PCI0.I2C3)
    {
        Device (CAM3)
        {
            ...
            Method (SSDB, 0, NotSerialized)
            {
                Name (PAR, Buffer (0x6C)
                {
                    ...
                    /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0010 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x06, 0x01, 0x00, 0x00,  // ........
                    /* 0020 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0028 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0030 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0038 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    ...
                    /* 0050 */  0x0A, 0x01, 0x03, 0x00, 0x00, 0x01, 0x00, 0xF8,  // ........
        ...
        Device (ICL2)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (SBUF) /* \_SB_.PCI0.I2C3.ICL2._CRS.SBUF */
            }
            ...
            Method (CLDB, 0, NotSerialized)
            {
                Name (PAR, Buffer (0x20)
                {
                    /* 0000 */  0x00, 0x01, 0x02, 0x20, 0x00, 0x0A, 0x01, 0x00,  // ... ....
                    /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00,  // ........
                    /* 0010 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00   // ........
                })
                Return (PAR) /* \_SB_.PCI0.I2C3.ICL2.CLDB.PAR_ */
            }
            ...
            Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == ToUUID ("79234640-9e10-4fea-a5c1-b5aa8b19756f")))
                {
                    ...
                    Else
                    {
                        ADBG ("ICL2: Revision 1 not supported")
                    }
                }
    ...
    Scope (_GPE)
    {
        Method (_L73, 0, Serialized)  // _Lxx: Level-Triggered GPE
        {
        }
